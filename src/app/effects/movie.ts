...
export class MovieEffects {
  ...
  search$: Observable<Action> = this.actions$
    ...
    .switchMap(query => {
      ...
      return this.searchMovies.searchMovies(query)
    ...
    /**
     * Creates an instance of MovieEffects.
     * @param {Actions} actions$ 
     * @param {SearchMoviesService} searchMovies 
     * @memberof MovieEffects
     */
    constructor(private actions$: Actions, private searchMovies: SearchMoviesService) { }
}
